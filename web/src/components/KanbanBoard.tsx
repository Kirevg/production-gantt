...
const SortableStageCard: React.FC<SortableStageCardProps> = ({
     ...
     *   - opacity: уменьшение прозрачности при перетаскивании (0.5 = 50%) для визуальной обратной связи
                                                                        ...
                                                                        {sortedProducts.map(([productKey, productTasks]) => {
                                                                            ...
                                                                            return (
                                                                                ...
                                                                                >
                                                                                     ...
                                                                                     * 
                                                                                     * НАЗНАЧЕНИЕ: Контейнер для карточки изделия с рамкой
                                                                                     * 
                                                                                     * СТИЛИ:
                                                                                     *   - border: '2px solid #423189' - рамка изделия (фиолетовый цвет)
                                                                                     *   - borderRadius: '4px' - скругление углов
                                                                                     * 
                                                                                     * КАК ИЗМЕНИТЬ:
                                                                                     *   - Цвет рамки: измените #423189 на другой цвет
                                                                                     *   - Толщину рамки: измените 2px
                                                                                     *   - Скругление: измените 4px
                                                                                     */}
                                                                                    <Paper
                                                                                        ...
                                                                                        {(() => {
                                                                                            ...
                                                                                            if (actualStages.length > 0) {
                                                                                                return (
                                                                                                    ...
                                                                                                    >
                                                                                                        {/* 
                                                                                                         * ===== КОНТЕЙНЕР КОЛОНКИ С ЭТАПАМИ РАБОТ =====
                                                                                                         ...
                                                                                                         *   - flexWrap: 'wrap' - перенос карточек на новую строку при переполнении
                                                                                                         *   - gap: 0.5 - расстояние между карточками этапов
                                                                                                         *   - alignItems: 'flex-start' - выравнивание по верхнему краю
                                                                                                         *   - minHeight: '60px' - минимальная высота для стабильности
                                                                                                         *   - position: 'relative' - для правильного позиционирования drag & drop
                                                                                                         *   - overflow: 'visible' - границы не обрезаются при hover эффектах
                                                                                                         *   - width: '100%' - полная ширина контейнера
                                                                                                         *   - ml: 2 - отступ слева
                                                                                                         *   - mb: 1 - отступ снизу
                                                                                                         * 
                                                                                                         * КАК ИЗМЕНИТЬ:
                                                                                                         *   - Расстояние между карточками: измените gap: 0.5
                                                                                                         *   - Отступы: измените ml: 2, mb: 1
                                                                                                         *   - Минимальную высоту: измените minHeight: '60px'
                                                                                                         *   - Поведение переноса: измените flexWrap: 'wrap' на 'nowrap' для одной строки
                                                                                                         */}
                                                                                                        <Box sx={{
                                                                                                            display: 'flex',
                                                                                                            flexWrap: 'wrap',
