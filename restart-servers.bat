...
REM Закрываем все пустые cmd окна и с PRODUCTION в заголовке
powershell -Command "Get-Process cmd | Where-Object { $_.MainWindowTitle -eq '' -or $_.MainWindowTitle -match 'PRODUCTION' } | Stop-Process -Force" 2>nul
